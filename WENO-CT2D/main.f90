    ...
    real p
    !p(x,y) = 1 - r2(x,y)/(8.0d0*pi**2)*exp(1 - r2(x,y)) ! smooth
    ...
    real v1
    !v1(x,y) = 1 - 1d0/(2.0d0*pi)*y*exp(0.5d0*(1 - r2(x,y))) ! smooth
    v1(x,y) = -sin(y) ! Orszag-Tang Vortex
    !v1(x,y) = ux0(x,y) ! Rotor
    real v2
    !v2(x,y) = 1 + 1d0/(2.0d0*pi)*x*exp(0.5d0*(1 - r2(x,y))) ! smooth
    v2(x,y) = sin(x) ! Orszag-Tang Vortex
    !v2(x,y) = uy0(x,y) ! Rotor
    real B1
    !B1(x,y) = -1d0/(2.0d0*pi)*y*exp(0.5d0*(1 - r2(x,y))) ! smooth
    B1(x,y) = -sin(y) ! Orszag-Tang Vortex
    !B1(x,y) = 2.4d0/(4d0*pi)**0.5d0 ! Rotor
    real B2
    !B2(x,y) = 1d0/(2.0d0*pi)*x*exp(0.5d0*(1 - r2(x,y))) ! smooth
    ...
    real A0
    !A0(x,y) = 1d0/(2d0*pi)*exp(0.5d0*(1 - r2(x,y))) ! ! smooth
    A0(x,y) = 0.5d0*cos(2d0*x) + cos(y) ! Orszag-Tang Vortex
    !A0(x,y) = 2.4d0*y/(4d0*pi)**0.5d0 ! Rotor
